...
# Get SqlAnywhere version number accordingly
set in [open $TOP/SQLANYWHERE_VERSION]
set zSqlAnywhereVersion [string trim [read $in]]
close $in
...
set declpatternsqlanywhere1 \
    {^ *([a-zA-Z][a-zA-Z_0-9 ]+ \**)(sqlanywhere_[_a-zA-Z0-9]+)(\(.*)$}
...
foreach file $filelist {
  ...
  while {![eof $in]} {
    ...
    regsub -- --SQLANYWHERE-VERS--    $line $zSqlAnywhereVersion line
    ...
    if {[regexp $varpattern $line] && ![regexp {^ *typedef} $line]} {
      ...
      if {[regexp $declpattern1 $line all rettype funcname rest] || \
          ...
          [regexp $declpatternsqlanywhere1 $line all rettype funcname rest]} {
        set line SQLITE_API
