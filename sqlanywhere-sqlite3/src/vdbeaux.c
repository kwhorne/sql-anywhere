  ...
  switch( pCx->eCurType ){
    ...
    case CURTYPE_VTAB: {
      ...
      if( pCx->isTracked ){
        ...
        sqlanywhere_inc_row_read(p, pTracked->nReads);
        sqlanywhere_inc_row_written(p, pTracked->nWrites);
      }
      pVCur->pVtab->nRef--;
    ...
    case CURTYPE_VECTOR_IDX: {
      ...
      sqlanywhere_inc_row_read(p, nReads);
      sqlanywhere_inc_row_written(p, nWrites);
      break;
    }
#endif
  }
