...
#
all:	sqlite3.h sqlite3ext.h libsqlanywhere.a sqlite3$(EXE)

libsqlanywhere.a: sqlite3.h	$(LIBOBJ)
	$(AR) libsqlanywhere.a $(LIBOBJ)
	$(RANLIB) libsqlanywhere.a

sqlite3$(EXE):	sqlite3.h libsqlanywhere.a shell.c
	$(TCCX) $(READLINE_FLAGS) -o sqlite3$(EXE) $(SHELL_OPT) \
		shell.c libsqlanywhere.a $(LIBREADLINE) $(TLIBS) $(THREADLIB)
...
#
tclsqlite3:	$(TOP)/src/tclsqlite.c libsqlanywhere.a
	$(TCCX) $(TCL_FLAGS) -DTCLSH -o tclsqlite3 \
		$(TOP)/src/tclsqlite.c libsqlanywhere.a $(LIBTCL) $(THREADLIB)
...
testfixture$(EXE): $(TESTSRC2) libsqlanywhere.a $(TESTSRC) $(TOP)/src/tclsqlite.c
	$(TCCX) $(TCL_FLAGS) $(TESTFIXTURE_FLAGS)                            \
		$(TESTSRC) $(TESTSRC2) $(TOP)/src/tclsqlite.c                \
		-o testfixture$(EXE) $(LIBTCL) libsqlanywhere.a $(THREADLIB)
...
# Multi-threaded test of the sqlanywhere_stmt_interrupt() API.  Builds a small
...
loadfts: $(TOP)/tool/loadfts.c libsqlanywhere.a
	$(TCC) $(TOP)/tool/loadfts.c libsqlanywhere.a -o loadfts $(THREADLIB)

threadtest5:	$(TOP)/test/threadtest5.c libsqlanywhere.a
	$(TCC) $(TOP)/test/threadtest5.c libsqlanywhere.a -o threadtest5 $(THREADLIB)
...
#
install:	sqlite3 libsqlanywhere.a sqlite3.h
	mv sqlite3 /usr/bin
	mv libsqlanywhere.a /usr/lib
