...
pub const SQLANYWHERE_VERSION: &[u8; 6] = b"0.3.0\0";
...
pub const SQLANYWHERE_STMTSTATUS_BASE: i32 = 1024;
pub const SQLANYWHERE_STMTSTATUS_ROWS_READ: i32 = 1025;
pub const SQLANYWHERE_STMTSTATUS_ROWS_WRITTEN: i32 = 1026;
...
extern "C" {
    pub fn sqlanywhere_libversion() -> *const ::std::os::raw::c_char;
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sqlanywhere_api_routines {
    _unused: [u8; 0],
}
...
extern "C" {
    pub fn sqlanywhere_open_v3(
        filename: *const ::std::os::raw::c_char,
        ppDb: *mut *mut sqlite3,
        flags: ::std::os::raw::c_int,
        zVfs: *const ::std::os::raw::c_char,
        wal_manager: sqlanywhere_wal_manager,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn sqlanywhere_try_initialize_wasm_func_table(db: *mut sqlite3) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
    pub fn sqlanywhere_stmt_interrupt(stmt: *mut sqlite3_stmt);
}
extern "C" {
...
extern "C" {
    pub fn sqlanywhere_wal_disable_checkpoint(db: *mut sqlite3) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sqlanywhere_wal_frame_count(
        arg1: *mut sqlite3,
        arg2: *mut ::std::os::raw::c_uint,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sqlanywhere_wal_get_frame(
        arg1: *mut sqlite3,
...
extern "C" {
    pub fn sqlanywhere_wal_insert_begin(arg1: *mut sqlite3) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sqlanywhere_wal_insert_end(arg1: *mut sqlite3) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn sqlanywhere_wal_insert_frame(
        arg1: *mut sqlite3,
        arg2: ::std::os::raw::c_uint,
        arg3: *mut ::std::os::raw::c_void,
        arg4: ::std::os::raw::c_uint,
...
pub type PgHdr = sqlanywhere_pghdr;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct PCache {
    _unused: [u8; 0],
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sqlanywhere_wal_methods {
    pub iVersion: ::std::os::raw::c_int,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct sqlanywhere_wal_manager {
...
pub struct RefCountedWalManager {
    ...
    pub ref_: sqlanywhere_wal_manager,
...
extern "C" {
    pub static sqlite3_wal_manager: sqlanywhere_wal_manager;
}
