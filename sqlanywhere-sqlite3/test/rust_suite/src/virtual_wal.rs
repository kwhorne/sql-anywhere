...
mod tests {
    ...
    use sqlanywhere_sys::rusqlite::{Connection, OpenFlags};
    ...
    impl WalManager for WrapWalManager {
        ...
        fn open(
            &self,
            vfs: &mut sqlanywhere_sys::wal::Vfs,
            file: &mut sqlanywhere_sys::wal::Sqlite3File,
            no_shm_mode: std::ffi::c_int,
            max_log_size: i64,
            db_path: &std::ffi::CStr,
        ) -> sqlanywhere_sys::wal::Result<Self::Wal> {
            self.inner
        ...
        fn close(
            &self,
            wal: &mut Self::Wal,
            db: &mut sqlanywhere_sys::wal::Sqlite3Db,
            sync_flags: std::ffi::c_int,
            scratch: Option<&mut [u8]>,
        ) -> sqlanywhere_sys::wal::Result<()> {
        ...
        fn log_exists(
            ...
            vfs: &mut sqlanywhere_sys::wal::Vfs,
            db_path: &std::ffi::CStr,
        ) -> sqlanywhere_sys::wal::Result<bool> {
    ...
    impl Wal for WrapWal {
        ...
        fn begin_read_txn(&mut self) -> sqlanywhere_sys::wal::Result<bool> {
        ...
        fn find_frame(
            &mut self,
            page_no: NonZeroU32,
        ) -> sqlanywhere_sys::wal::Result<Option<NonZeroU32>> {
        ...
        fn frame_count(&self, locked: i32) -> sqlanywhere_sys::wal::Result<u32> {
        ...
        fn begin_write_txn(&mut self) -> sqlanywhere_sys::wal::Result<()> {
            self.0.begin_write_txn()
        }

        fn end_write_txn(&mut self) -> sqlanywhere_sys::wal::Result<()> {
            self.0.end_write_txn()
        }

        fn undo<U: sqlanywhere_sys::wal::UndoHandler>(
            &mut self,
        ...
        fn savepoint_undo(&mut self, rollback_data: &mut [u32]) -> sqlanywhere_sys::wal::Result<()> {
        ...
        fn insert_frames(
            ...
            page_headers: &mut sqlanywhere_sys::wal::PageHeaders,
            size_after: u32,
            is_commit: bool,
            sync_flags: std::ffi::c_int,
        ) -> sqlanywhere_sys::wal::Result<usize> {
            self.0
        ...
        fn checkpoint(
            &mut self,
            db: &mut sqlanywhere_sys::wal::Sqlite3Db,
            mode: sqlanywhere_sys::wal::CheckpointMode,
        ...
        fn exclusive_mode(&mut self, op: std::ffi::c_int) -> sqlanywhere_sys::wal::Result<()> {
        ...
        fn set_db(&mut self, db: &mut sqlanywhere_sys::wal::Sqlite3Db) {
            self.0.set_db(db)
        }
