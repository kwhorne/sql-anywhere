/*
 * GENERATE: python3 test_sqlanywhere_f16.py > test_sqlanywhere_f16_table.h
 * BUILD: cc test_sqlanywhere_f16.c -I ../ -L ../.libs -lsqlanywhere -lm -o test_sqlanywhere_f16
 * RUN:   LD_LIBRARY_PATH=../.libs ./test_sqlanywhere_diskann
*/
...
#include "test_sqlanywhere_f16_table.h"
