...
pub type Wal = crate::ffi::sqlanywhere_wal;
use crate::ffi::{sqlanywhere_wal_methods, sqlite3, sqlite3_file, sqlite3_vfs, PgHdr};
...
pub type XWalPreMainDbOpen =
    extern "C" fn(methods: *mut sqlanywhere_wal_methods, path: *const c_char) -> c_int;
pub type XWalOpenFn = extern "C" fn(
    ...
    no_shm_mode: c_int,
    max_size: i64,
    methods: *mut sqlanywhere_wal_methods,
    wal: *mut *mut Wal,
) -> c_int;
