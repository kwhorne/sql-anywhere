...
use sqlanywhere_sys::Cipher;

pub const SQLANYWHERE_PAGE_SIZE: usize = 4096;
...
impl FrameEncryptor {
    pub fn new(encryption_config: sqlanywhere_sys::EncryptionConfig) -> Self {
    ...
    pub fn encrypt(&self, data: &mut [u8]) -> Result<(), rusqlite::ffi::Error> {
        ...
        self.enc
            ...
            .map_err(|_| rusqlite::ffi::Error::new(sqlanywhere_sys::ffi::SQLITE_IOERR_WRITE))?;
        Ok(())
    }
    ...
    pub fn decrypt(&self, data: &mut [u8]) -> Result<(), rusqlite::ffi::Error> {
        ...
        self.dec
            ...
            .map_err(|_| rusqlite::ffi::Error::new(sqlanywhere_sys::ffi::SQLITE_IOERR_READ))?;
        Ok(())
    }
}
