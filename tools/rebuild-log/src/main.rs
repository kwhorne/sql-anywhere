...
pub const FRAME_SIZE: usize = std::mem::size_of::<FrameHeader>() + SQLANYWHERE_PAGE_SIZE as usize;
...
fn main() -> anyhow::Result<()> {
    ...
    loop {
        ...
        if page_seen.get(&page_no).is_none() {
            ...
            let offset = (page_no - 1) * SQLANYWHERE_PAGE_SIZE as u32;
...
pub struct FrameBorrowed {
    header: FrameHeader,
    page: [u8; SQLANYWHERE_PAGE_SIZE as usize],
}
