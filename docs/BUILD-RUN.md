...
You can also use the [elyra cli](https://docs.elyra.dev/reference/elyra-cli) to connect to the sqld instance:
...
### 1. Add the tap `sqlanywhere/sqld` to Homebrew

```bash
brew tap sqlanywhere/sqld
```
...
Run the following to build a Docker image named "sqlanywhere/sqld" tagged with
version "latest".
...
[sqld container release tags]: https://github.com/sqlanywhere/sqld/pkgs/container/sqld
[sqld release tags]: https://github.com/sqlanywhere/sqld/releases
