...
use sqlanywhere_ffi::{
    sqlanywhere_wal, sqlanywhere_wal_manager, sqlite3_wal, sqlite3_wal_manager, Error, SQLITE_OK,
    WAL_SAVEPOINT_NDATA,
};
...
impl WalManager for Sqlite3WalManager {
    ...
    fn open(
        ...
        let mut wal: MaybeUninit<sqlanywhere_wal> = MaybeUninit::uninit();
        let rc = unsafe {
