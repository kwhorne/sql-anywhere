...
*/
void sqlanywhereAlterAlterColumn(
  Parse *pParse,                  /* Parsing context */
  SrcList *pSrc,                  /* Table being altered.  pSrc->nSrc==1 */
  Token *pOld,                    /* Name of column being changed */
  ...
  */
  ...
  sqlite3NestedParse(pParse, 
      "UPDATE \"%w\"." LEGACY_SCHEMA_TABLE " SET "
      "sql = sqlanywhere_alter_column(sql, %Q, %Q, %d, %Q, %d, %d, %d) "
...
** SQL function:
**
**     sqlanywhere_alter_column(SQL,TYPE,OBJ,DB,TABLE,COL,NEWNAME,QUOTE,TEMP)
**
**   0. zSql:     SQL statement to rewrite
...
void sqlite3AlterFunctions(void){
  static FuncDef aAlterTableFuncs[] = {
    ...
    // SqlAnywhere extensions
    INTERNAL_FUNCTION(sqlanywhere_alter_column, 8, alterColumnFunc),
  };
