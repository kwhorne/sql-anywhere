...
use sqlanywhere_replication::meta::WalIndexMeta;
use sqlanywhere_replication::replicator::{Error, ReplicatorClient};
...
impl ReplicatorClient for Client {
    ...
    async fn commit_frame_no(
        &mut self,
        frame_no: sqlanywhere_replication::frame::FrameNo,
    ) -> Result<(), Error> {
