...
#[cfg(feature = "core")]
pub(crate) fn error_from_handle(raw: *mut sqlanywhere_sys::ffi::sqlite3) -> String {
    let errmsg = unsafe { sqlanywhere_sys::ffi::sqlite3_errmsg(raw) };
    sqlite_errmsg_to_string(errmsg)
}

#[cfg(feature = "core")]
pub(crate) fn extended_error_code(raw: *mut sqlanywhere_sys::ffi::sqlite3) -> std::ffi::c_int {
    unsafe { sqlanywhere_sys::ffi::sqlite3_extended_errcode(raw) }
}

#[cfg(feature = "core")]
pub fn error_from_code(code: i32) -> String {
    let errmsg = unsafe { sqlanywhere_sys::ffi::sqlite3_errstr(code) };
    sqlite_errmsg_to_string(errmsg)
}
