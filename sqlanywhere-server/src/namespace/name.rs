...
impl Into<sqlanywhere_sys::name::NamespaceName> for NamespaceName {
    fn into(self) -> sqlanywhere_sys::name::NamespaceName {
        sqlanywhere_sys::name::NamespaceName(self.0)
    }
}
