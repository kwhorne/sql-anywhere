...
typedef int (*sqlite3_loadext_entry)(
  ...
  const sqlanywhere_api_routines *pThunkSqlanywhere /* Extension API function pointers - SqlAnywhere.*/
);
...
# define SQLANYWHERE_EXTENSION_INIT1     const sqlanywhere_api_routines *sqlanywhere_api=0;
