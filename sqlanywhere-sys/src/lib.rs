...
pub mod ffi {
    //! C ffi for sqlanywhere.

    pub use sqlanywhere_ffi::*;
    use zerocopy::byteorder::big_endian::{U16 as bu16, U32 as bu32, U64 as bu64};

    /// Patched database header file, in use by sqlanywhere
    ...
    pub struct Sqlite3DbHeader {
        ...
        _reserved: [u8; 12],
        /// The replication index of this database, this is a sqlanywhere extension, ignored by sqlite3.
