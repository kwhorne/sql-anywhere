...
/// The possible types a column can be in sqlanywhere.
...
#[cfg(feature = "core")]
impl From<sqlanywhere_sys::Value> for Value {
    fn from(value: sqlanywhere_sys::Value) -> Value {
...
#[cfg(feature = "core")]
impl<'a> From<sqlanywhere_sys::Value> for ValueRef<'a> {
    fn from(value: sqlanywhere_sys::Value) -> ValueRef<'a> {
        match value.value_type().into() {
...
#[cfg(feature = "core")]
impl From<sqlanywhere_sys::ValueType> for ValueType {
    fn from(other: sqlanywhere_sys::ValueType) -> Self {
        match other {
            sqlanywhere_sys::ValueType::Integer => ValueType::Integer,
            sqlanywhere_sys::ValueType::Real => ValueType::Real,
            sqlanywhere_sys::ValueType::Text => ValueType::Text,
            sqlanywhere_sys::ValueType::Blob => ValueType::Blob,
            sqlanywhere_sys::ValueType::Null => ValueType::Null,
        }
    }
}

#[cfg(feature = "replication")]
impl TryFrom<&sqlanywhere_replication::rpc::proxy::Value> for Value {
    type Error = Error;

    fn try_from(value: &sqlanywhere_replication::rpc::proxy::Value) -> Result<Self> {
