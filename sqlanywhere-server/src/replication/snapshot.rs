...
use sqlanywhere_replication::frame::FrameMut;
use sqlanywhere_replication::snapshot::{SnapshotFile, SnapshotFileHeader};
...
mod test {
    ...
    use bytes::Bytes;
    use sqlanywhere_replication::frame::Frame;
            ...
            move || {
                ...
                logfile
                    .push_page(&WalPage {
                        page_no: 0,
                        size_after: 1,
                        data: Bytes::from_static(&[0; SQLANYWHERE_PAGE_SIZE as _]),
                    })
                    .unwrap();
