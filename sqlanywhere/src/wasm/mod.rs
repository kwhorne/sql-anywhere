...
//! ```toml,ignore,no_run
//! [packages]
//! sqlanywhere = { version = "*", default-features = false, features = ["cloudflare"] }
//! ```
//!
//! # Example Rust usage
//!
//! ```rust,no_run
//! use sqlanywhere::wasm::Connection;
//!
//! let conn = Connection::open_cloudflare_worker("sqlanywhere://my-elyra-db.elyra.io", "my-auth-token");
//!
...
use sqlanywhere_hrana::proto::{Batch, Stmt};
