...
impl InnerConnection {
    ...
    pub fn open_with_flags(
        ...
        unsafe {
            ...
            #[cfg(not(feature = "sqlanywhere-experimental"))]
            ...
            #[cfg(feature = "sqlanywhere-wasm-experimental")]
    ...
    pub fn try_initialize_wasm_func_table(&self) -> Result<()> {
        self.decode_result(unsafe { ffi::sqlanywhere_try_initialize_wasm_func_table(self.db) })
    }
}
