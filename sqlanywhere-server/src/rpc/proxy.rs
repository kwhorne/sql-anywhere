...
pub mod rpc {
    use anyhow::Context;
    pub use sqlanywhere_replication::rpc::proxy::*;
    ...
    impl From<SqldError> for Error {
        fn from(other: SqldError) -> Self {
            let code = match other {
                SqldError::SqlAnywhereInvalidQueryParams(_) => ErrorCode::SqlError,
                SqldError::SqlAnywhereTxTimeout => ErrorCode::TxTimeout,
                SqldError::SqlAnywhereTxBusy => ErrorCode::TxBusy,
...
impl QueryResultBuilder for ExecuteResultsBuilder {
    ...
    fn finish(
        ...
        use sqlanywhere_replication::rpc::proxy::State;
