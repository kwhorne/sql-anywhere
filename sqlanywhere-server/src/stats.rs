...
impl Stats {
    ...
    fn inc_rows_written(&self, n: u64) {
        counter!("sqlanywhere_server_rows_written", n, "namespace" => self.namespace.to_string());
        self.rows_written.fetch_add(n, Ordering::Relaxed);
    }

    fn inc_query(&self, d: Duration) {
        let micros = d.as_micros() as u64;
        counter!("sqlanywhere_server_query_count", 1, "namespace" => self.namespace.to_string());
        counter!("sqlanywhere_server_query_latency", micros / 1000, "namespace" => self.namespace.to_string());
    ...
    fn inc_rows_read(&self, n: u64) {
        counter!("sqlanywhere_server_rows_read", n, "namespace" => self.namespace.to_string());
        self.rows_read.fetch_add(n, Ordering::Relaxed);
    }

    pub fn set_storage_bytes_used(&self, n: u64) {
        gauge!("sqlanywhere_server_storage", n as f64, "namespace" => self.namespace.to_string());
    ...
    pub fn inc_write_requests_delegated(&self) {
        increment_counter!("sqlanywhere_server_write_requests_delegated", "namespace" => self.namespace.to_string());
    ...
    pub fn inc_embedded_replica_frames_replicated(&self) {
        increment_counter!("sqlanywhere_server_embedded_replica_frames_replicated", "namespace" => self.namespace.to_string());
    ...
    pub fn set_current_frame_no(&self, fno: FrameNo) {
        gauge!("sqlanywhere_server_current_frame_no", fno as f64, "namespace" => self.namespace.to_string());
    ...
    fn update_query_metrics(&self, rows_read: u64, rows_written: u64, mem_used: u64, elapsed: u64) {
        increment_counter!("sqlanywhere_server_query_count");
        counter!("sqlanywhere_server_query_latency", elapsed);
        counter!("sqlanywhere_server_query_rows_read", rows_read);
        counter!("sqlanywhere_server_query_rows_written", rows_written);
        counter!("sqlanywhere_server_query_mem_used", mem_used);
    }
