...
use sqlanywhere_sys::ffi::{SQLITE_BUSY, SQLITE_IOERR_WRITE};
use sqlanywhere_sys::wal::wrapper::{WalWrapper, WrapWal};
...
impl<T: Wal> WrapWal<T> for BottomlessWalWrapper {
    ...
    fn close<M: sqlanywhere_sys::wal::WalManager<Wal = T>>(
        &mut self,
        manager: &M,
        wrapped: &mut T,
