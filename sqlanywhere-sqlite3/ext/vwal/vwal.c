...
** sqlanywhere_wal_methods_register(). Later, a registered set can
** be used by passing its name as a parameter to sqlanywhere_open().
*/

extern int sqlanywhere_wal_methods_register(sqlanywhere_wal_methods*);

static int v_open(sqlite3_vfs *pVfs, sqlite3_file *pDbFd, const char *zWalName, int bNoShm, i64 mxWalSize, sqlanywhere_wal_methods *pMethods, Wal **ppWal) {
  //TODO: implement
