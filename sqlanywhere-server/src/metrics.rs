...
pub static WRITE_TXN_DURATION: Lazy<Histogram> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_write_txn_duration";
...
pub static PROGRAM_EXEC_COUNT: Lazy<Counter> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_sqlanywhere_execute_program";
    describe_counter!(NAME, "number of hrana program executions");
    register_counter!(NAME)
});
pub static REPLICA_LOCAL_EXEC_MISPREDICT: Lazy<Counter> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_replica_exec_mispredict";
    describe_counter!(
        NAME,
...
pub static REPLICA_LOCAL_PROGRAM_EXEC: Lazy<Counter> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_replica_exec";
    describe_counter!(
        NAME,
...
pub static REPLICATION_LATENCY: Lazy<Histogram> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_replication_latency";
    describe_counter!(
        NAME,
...
pub static REPLICATION_LATENCY_OUT_OF_SYNC: Lazy<Counter> = Lazy::new(|| {
    const NAME: &str = "sqlanywhere_server_replication_latency_out_of_sync";
    describe_counter!(
        NAME,
